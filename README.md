...
> - 각 변수의 SHAP 기여도를 분석하여 조건에 따른 식각율 차이를 분석하고자 함
### 성과
...
> - RF 파워($P_{RF}$)
> #### 광학 데이터
> - 스마트폰 카메라 기반의 디지털 이미지 컬러리메트리(DIC)를 통한 R, G, B  값 추출
### 머신러닝 모델 구축
> #### 사용 모델
> - 선형 회귀
> - ANN
...
### 데이터 샘플 부족 문제
#### 문제
> 실제 공정 데이터의 샘플 수 부족으로 인해 학습 모델의 과적합 위험 및 변수 간 복잡한 비선형적 메커니즘 학습의 한계가 있음
#### 해결 방법
> - 기존의 실험 데이터에 가우시안 분포 기반의 미세한 노이즈를 추가하여 가상의 데이터 샘플 생성
> - 랜덤 포레스트의 경우 적은 데이터셋에서도 상대적으로 높은 일반화 성능을 가짐
